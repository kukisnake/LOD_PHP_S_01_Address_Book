...
use Address_Book\AddressBookBundle\Entity\Address;
...
class AddressController extends Controller
{
    ...
    {
        $address = new Address();
        $form = $this->createForm('Address_Book\AddressBookBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('Address_Book\AddressBookBundle\Form\AddressType', $address);
