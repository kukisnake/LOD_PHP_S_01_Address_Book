...
use Address_Book\AddressBookBundle\Entity\Phone;
...
class PhoneController extends Controller
{
    ...
    {
        $phone = new Phone();
        $form = $this->createForm('Address_Book\AddressBookBundle\Form\PhoneType', $phone);
    ...
    {
        $deleteForm = $this->createDeleteForm($phone);
        $editForm = $this->createForm('Address_Book\AddressBookBundle\Form\PhoneType', $phone);
