...
use Address_Book\AddressBookBundle\Entity\Email;
...
class EmailController extends Controller
{
    ...
    {
        $email = new Email();
        $form = $this->createForm('Address_Book\AddressBookBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('Address_Book\AddressBookBundle\Form\EmailType', $email);
